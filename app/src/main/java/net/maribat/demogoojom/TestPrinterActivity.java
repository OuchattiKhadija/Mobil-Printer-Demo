...
public class TestPrinterActivity extends AppCompatActivity {
   ...
   // Step 9: Write code to find Bluetooth adapter
  ...
  //  Step 10: Write code to open Bluetooth device or printer.
    ...
    //Step 9: At last send command to print text to Bluetooth Printer and disconnect Bluetooth device
    ...
    //http://wintechtutorials.com/blog/android-send-print-command-bluetooth-printer-mobile/
